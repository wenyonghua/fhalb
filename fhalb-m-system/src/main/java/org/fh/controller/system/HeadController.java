...
public class HeadController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/listnacos")
	@ResponseBody
	public Object listnacos()throws Exception{
		Map<String,String> map = new HashMap<String,String>();
		String errInfo = "success";
		List<Dictionaries> list	= new ArrayList<Dictionaries>();
		List<Dictionaries> dictList = dictionariesService.listSubDictByParentId("nacos");					//nacos 此ID为数字字典 注册中心的ID，取其子一级数据
		for(Dictionaries dict : dictList){
			dict.setTreeurl("nacos.html?nacosnum="+(Integer.parseInt(dict.getORDER_BY())-1));
			dict.setSubDict(null);
			dict.setTarget("treeFrame");
			list.add(dict);
		}
	...
	/**
	 * 显示微服务列表(用于网络、服务器检测、Swagger接口)
	 * @return
	 */
	@RequestMapping(value="/listMshostCheck")
	@ResponseBody
	public Object listMshostCheck(String type)throws Exception{
		Map<String,String> map = new HashMap<String,String>();
		String errInfo = "success";
		List<Dictionaries> list	= new ArrayList<Dictionaries>();
		List<Dictionaries> dictList = dictionariesService.listSubDictByParentId("msid");					//msid 此ID为数字字典 微服务的ID，取其子一级数据
