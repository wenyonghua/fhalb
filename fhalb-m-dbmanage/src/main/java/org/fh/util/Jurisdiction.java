...
public class Jurisdiction {
	 ...
	 * @return
	 */
	public static String getNowProperties(){
		return getSession().getAttribute(Const.PROPERTIES).toString();
	}
	
	/**获取当前数据库备份文件名称
	 * @return
	 */
	public static void putKeyToSession(String key, Object value){
