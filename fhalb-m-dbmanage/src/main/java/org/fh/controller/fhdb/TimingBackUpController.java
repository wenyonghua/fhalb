...
public class TimingBackUpController extends BaseController {
	...
	public Object save() throws Exception{
		...
		this.addJob(JOBNAME, FHTIME, TABLENAME,TIMINGBACKUP_ID,properties);		//添加任务
	...
	public Object goAdd()throws Exception{
		...
		String errInfo = "success";
		String properties = Jurisdiction.getNowProperties();	//备份配置文件
		Object[] arrOb = DbFH.getTables(properties);
	 ...
	 */
	public void addJob(String JOBNAME, String FHTIME, String TABLENAME, String TIMINGBACKUP_ID, String properties){
